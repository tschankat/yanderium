...
public class SWP_HeartRateMonitor : MonoBehaviour
{
	...
	void Update()
	{
		...
		{			
			...
			NewClone.transform.position += new Vector3(BlipMonitorWidth * TimeFactor * LineSpeed, Random.Range(-0.05f, 0.05f), 0);
		else
		{
			NewClone.transform.position += new Vector3(BlipMonitorWidth * TimeFactor * LineSpeed, 0, 0);
