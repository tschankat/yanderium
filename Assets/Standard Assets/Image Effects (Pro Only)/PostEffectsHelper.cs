...
public class PostEffectsHelper : MonoBehaviour
{
		...
		Material material, Camera cameraForProjectionMatrix)
	{
		...
		float fovYHalfRad = cameraForProjectionMatrix.fieldOfView * 0.50f * Mathf.Deg2Rad;
	...
	static void DrawLowLevelQuad(float x1, float x2, float y1, float y2, RenderTexture source,
